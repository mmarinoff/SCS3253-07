...
param_grid = {
    ...
    'gradboost__subsample': [0.5, 0.7, 1, 1.3, 1.5],
    'gradboost__learning_rate': [0.1, 0.5, 0.7, 1, 1.2, 1.5],
    'gradboost__criterion': ['friedman_mse', 'mse'],
    'gradboost__min_samples_split': [5, 10, 15],
    'gradboost__min_samples_leaf': [2, 5, 10]
}
